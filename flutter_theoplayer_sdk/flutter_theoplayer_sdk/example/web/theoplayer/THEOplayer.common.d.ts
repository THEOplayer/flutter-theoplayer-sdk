...
interface AdsConfiguration {
    ...
    /**
     * The configuration for the THEOplayer CSAI ad integration.
     */
    csai?: CsaiConfiguration;
}
/**
 * Describes the configuration of the THEOplayer CSAI ad integration.
 *
 * @category Ads
 * @public
 */
interface CsaiConfiguration {
    /**
     * The recommended bitrate in kbit/s for selecting ad media files.
     *
     * @remarks
     * <br/> - When set to `-1`, the player picks the ad media file with the highest available bitrate
     *         (matching the behavior of {@link GoogleImaConfiguration.bitrate}).
     * <br/> - When set to a positive value, the player picks the highest-bitrate ad media file at or below the
     *         specified maximum. If no ad has a bitrate at or below the maximum, the ad with the bitrate closest to
     *         the maximum is picked.
     * <br/> - When set to `0` (the default), no bitrate-based selection is performed; the player falls back to its
     *         default resolution-based selection for progressive media files.
     * <br/> - When bitrate-based selection is active (`-1` or positive), it overrides the default resolution-based
     *         selection for progressive (e.g. mp4) ad media files.
     * <br/> - Bitrate information is taken from the `bitrate` attribute on the VAST `<MediaFile>` element. Media
     *         files without this attribute are skipped during bitrate-based selection.
     *
     * @defaultValue 0
     */
    bitrate?: number;
    /**
     * The maximum amount of time, in milliseconds, to wait for an ad media file to start playing
     * after its source has been set. If the ad does not start playing within this time, an ad
     * error will be reported and playback will continue with the main content (or the next ad).
     *
     * @remarks
     * <br/> - When set to `0`, no timeout is applied (the player will wait indefinitely).
     *
     * @defaultValue `0`
     */
...
interface GoogleImaConfiguration {
    ...
    /**
     * Whether non-linear ads should be rendered with the Google IMA SDK's native styling.
     *
     * @remarks
     * <br/> - This is forwarded to `google.ima.AdsRenderingSettings.useStyledNonLinearAds`.
     * <br/> - See {@link https://developers.google.com/interactive-media-ads/docs/sdks/html5/client-side/reference/class/google.ima.AdsRenderingSettings#google.ima.AdsRenderingSettings.useStyledNonLinearAds | the IMA SDK reference}.
     * <br/> - When left `undefined`, the IMA SDK default is used.
     *
     * @defaultValue undefined
     */
    useStyledNonLinearAds?: boolean;
    /**
     * Whether linear ads should be rendered with the Google IMA SDK's native styling.
     *
     * @remarks
     * <br/> - This is forwarded to `google.ima.AdsRenderingSettings.useStyledLinearAds`.
     * <br/> - See {@link https://developers.google.com/interactive-media-ads/docs/sdks/html5/client-side/reference/class/google.ima.AdsRenderingSettings#google.ima.AdsRenderingSettings.useStyledLinearAds | the IMA SDK reference}.
     * <br/> - When left `undefined`, the IMA SDK default is used.
     *
     * @defaultValue undefined
     */
...
interface MediaFile {
    ...
    height: number;
    /**
     * The bitrate of the video file, in kbit/s.
     *
     * @remarks
     * <br/> - Available when the VAST `<MediaFile>` element has a `bitrate` attribute.
     */
    bitrate?: number;
    /**
...
interface SourceAbrConfiguration {
     ...
     *
     * @remarks
     * <br/> - If unset, Dolby Vision and HEVC are preferred over other codecs at the initial variant stream selection.
     * <br/> - Set an empty list to disable any codec preference.
     */
...
interface PlayerConfiguration {
     ...
     * for example by calling [`navigator.getAutoplayPolicy()`](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/getAutoplayPolicy)
     * or by attempting to autoplay an off-screen `<video>` element.
     *
     * However, on some lower-end smart TVs or set-top boxes, this auto-detection itself may sometimes be very slow or even fail,
     * for example because the platform does not support multiple `<video>` elements attempting to play at the same time.
     * In these cases, you may want to explicitly override the capability yourself (based on knowledge about the current platform's capabilities)
     * so the player can skip its auto-detection.
     *
     * <strong>This is an advanced API.</strong> It should only be used when you have *specific* knowledge about which platform(s)
     * and which device(s) you are targeting.
     *
     * <ul>
     * <li>Available since 11.8.0.</li>
     * </ul>
     *
     * @defaultValue `undefined`, i.e. the player will attempt to auto-detect the platform's autoplay capabilities.
     */
...
interface NetworkConfiguration {
     ...
     * @remarks
     * <br/> - Available since v11.9.0.
     * <br/> - When this option is set to false, the player will not try to consume fetch responses as streams (override for devices with broken streaming-fetch support).
     *
     * @defaultValue `true`
     */
...
/**
 * The autoplay capability of the platform.
 *
 * <ul>
 * <li>`allowed` - Autoplay is allowed.</li>
 * <li>`allowed-muted` - Autoplay is allowed only for inaudible media. This includes media that has no audio track, or for which the audio has been muted.</li>
 * <li>`disallowed` - Autoplay is not allowed.</li>
 * </ul>
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/API/Navigator/getAutoplayPolicy
 * @category Player
 * @public
 */
type AutoplayCapability = 'allowed' | 'allowed-muted' | 'disallowed';
/**
...
interface DashPlaybackConfiguration {
     ...
     *
     * @remarks
     * <br/> - Available since v10.9.0.
     *
     * @defaultValue `true`
     */
    contentSteering?: boolean;
}
...
interface TheoLiveSource extends TypedSource {
    ...
    profile?: string;
    /**
     * Object containing connect options for connecting to a WebRTC live source returned by THEOlive.
     * See {@link MillicastSource.connectOptions}.
     */
...
interface BaseSource {
    ...
    hlsDateRange?: boolean;
    /**
     * Whether the player should extract C2PA (Coalition for Content Provenance and Authenticity) metadata
     * from the stream's ISOBMFF segments and expose it through {@link C2PAMetadataEvent | `c2pametadata`} events.
     *
     * @defaultValue `false`
     *
     * @remarks
     * <br/> - The player does not validate C2PA signatures. Pass the exposed data to a third-party C2PA validation library.
     * <br/> - Only supported for fMP4/CMAF content played through the player's own HLS and MPEG-DASH pipelines.
     *         Ignored for native playback (see {@link BaseSource.useNativePlayback}), MPEG-TS content and HESP streams.
     */
    c2paMetadata?: boolean;
    /**
     ...
     *
     * @remarks
     * <br/> - When specified, this configuration overrides the player-level {@link PlayerConfiguration.retryConfiguration} for this source.
     * <br/> - If not specified, falls back to the global player retry configuration.
     */
    retryConfiguration?: RetryConfiguration;
}
/**
...
/**
 * The type of segment in which C2PA metadata was found.
 *
 * @category Events
 * @public
 */
type C2PASegmentType = 'initialization' | 'media';
/**
 * The type of media track in which C2PA metadata was found.
 *
 * @category Events
 * @public
 */
type C2PAMediaType = 'audio' | 'video';
/**
 * Fired when the player encounters a C2PA (Coalition for Content Provenance and Authenticity) `uuid` box
 * while buffering an ISOBMFF initialization or media segment.
 *
 * @remarks
 * <br/> - Only fired if C2PA metadata extraction is enabled through {@link BaseSource.c2paMetadata}.
 * <br/> - Only fired for fMP4/CMAF content played through the player's own HLS and MPEG-DASH pipelines.
 *         Not fired for native playback (see {@link BaseSource.useNativePlayback}), MPEG-TS content or HESP streams.
 * <br/> - Every C2PA `uuid` box encountered is exposed, including boxes with identical contents, e.g. when the same
 *         initialization segment is buffered again after a quality switch. Deduplication is left to the application.
 * <br/> - The player does not validate C2PA signatures. Pass the exposed data to a third-party C2PA validation library.
 * <br/> - Timed C2PA event messages carried in `emsg` boxes are exposed separately, as cues of an `emsg` metadata text track.
 *
 * @category Events
 * @public
 */
interface C2PAMetadataEvent extends Event<'c2pametadata'> {
    /**
     ...
     *
     * @remarks
     * <br/> - For purpose `'manifest'`, this contains the merkle offset followed by the C2PA manifest store (JUMBF).
     * <br/> - For purpose `'merkle'`, this contains the CBOR-serialized merkle row data.
     */
    readonly data: Uint8Array;
    /**
     * The type of segment in which the C2PA metadata was found.
     */
    readonly segmentType: C2PASegmentType;
    /**
     * The type of media track in which the C2PA metadata was found.
     *
     * @remarks
     * <br/> - When audio and video are carried in separate tracks, each track is a separate C2PA-signed stream
     *         with its own manifest and merkle data. Use this property to associate the metadata with the correct track.
     */
    readonly mediaType: C2PAMediaType;
    /**
     * The start time of the media segment in which the C2PA metadata was found.
     *
     * @remarks
     * <br/> - Only available if {@link C2PAMetadataEvent.segmentType} is `'media'`.
     */
 ...
 * @public
 */
interface ContentSteeringStopEvent extends Event<'contentsteeringstop'> {
}
/**
 ...
 * @public
 */
interface ContentSteeringStartEvent extends Event<'contentsteeringstart'> {
}
/**
 ...
 * @public
 */
interface ContentSteeringUpdateEvent extends Event<'contentsteeringupdate'> {
    /**
 ...
 * @public
 */
interface ContentSteeringLocationChangeEvent extends Event<'contentsteeringlocationchange'> {
    /**
 ...
 * @public
 */
interface ContentSteeringErrorEvent extends Event<'contentsteeringerror'> {
    /**
 ...
 * @public
 */
type RequestType = '' | 'manifest' | 'segment' | 'preload-hint' | 'content-protection' | 'content-steering';
/**
 ...
 * @public
 */
interface DistributionLoadedEvent extends Event<'distributionloaded'> {
...
interface TheoLiveApiEventMap {
    ...
    readonly distributionloaded: DistributionLoadedEvent;
...
/**
 * The playout delay for the WebRTC configuration for a THEOlive Millicast source.
 *
 * @category THEOlive
 * @public
 */
interface PlayoutDelay {
    minimum: number;
    maximum: number;
}
/**
...
interface PlayerEventMap {
    ...
    /**
     * Fired when C2PA metadata is encountered in the stream.
     *
     * @remarks
     * <br/> - Only fired if C2PA metadata extraction is enabled through {@link BaseSource.c2paMetadata}.
     * <br/> - The player does not validate the C2PA metadata. It only exposes the raw data to the application.
     */
    c2pametadata: C2PAMetadataEvent;
    /**
