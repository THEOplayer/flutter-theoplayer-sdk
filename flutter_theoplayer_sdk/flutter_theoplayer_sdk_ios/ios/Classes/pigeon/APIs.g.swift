...
class THEOplayerNativeTHEOliveAPISetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: THEOplayerNativeTHEOliveAPI?, messageChannelSuffix: String = "") {
    ...
    let switchToHespChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.theoplayer_platform_interface.THEOplayerNativeTHEOliveAPI.switchToHesp\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      switchToHespChannel.setMessageHandler { _, reply in
        do {
          try api.switchToHesp()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      switchToHespChannel.setMessageHandler(nil)
    }
